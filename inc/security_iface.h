 ...
 *
 * @return           Errcode of authentication check, 0 if authentication was
 * successful
 * @retval 0         Successful Authentication
 *
 * @iclass security_iface
 */
int8_t npnt_check_authenticity(npnt_s *handle, uint8_t *hashed_data, uint16_t hashed_data_len,
 ...
 *
 * @return           Errcode of signature failure, 0 if signature was generated
 * successfully
 * @retval 0         Successfully Signed
 *
 * @iclass security_iface
 */
int8_t npnt_sign_raw_data(npnt_s *handle, uint8_t *raw_data, uint16_t raw_data_len,
